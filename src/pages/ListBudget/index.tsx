...
import { ChartLineUpIcon, MagnifyingGlassIcon, NotePencilIcon } from "@phosphor-icons/react";
      ...
      <div
        ...
        <div className=" w-[400px] max-w-[600px] space-y-4">
          <div className="flex gap-2 items-center">
            ...
            <MagnifyingGlassIcon size={35} color="white" className="bg-zinc-900 p-1 rounded-md" onClick={listBudgetBy} />
          </div>
          ...
          <div className="flex justify-between gap-2">
            ...
            <Button size={'sm'} onClick={handleDasboard}><ChartLineUpIcon size={16} /></Button>
            <Button size={'sm'} onClick={handleNewBudget}><NotePencilIcon size={16} /></Button>
